...
KarmaHQ Integration (January 2026) Project Profile: https://www.karmahq.xyz/project/goodmarket Metrics Tracked:

Unique Users: Tracked via RewardDisbursed events on LearnAndEarnRewards contract.
Legacy Impact: 1,100+ transactions from the initial MVP phase (direct wallet-to-wallet).
